...
> **Proposed v5 contract:** this branch contains an unreleased v5 design under
> [`v5/`](v5/README.md). Start with the [v5 overview](v5/README.md) and
> [5.0 upgrade guide](v5/docs/UPGRADE-GUIDE-5.0.md). The root module and the
> documentation below continue to describe the current v4 contract.
